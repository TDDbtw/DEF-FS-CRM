...
if (isMockMode) {
  if (MOCK_DB.getCustomers().length === 0) {
    ...
    const defaultFills = [
      { id: 'f1', ts: new Date(Date.now()-86400000*45).toISOString(), entry_type:'sale', employee:'Basil', machine:'hp', vehicle:'TN72AB1234', driver:'Mariyappan', driverPh:'9786932624', company:'MMS Transport', coPh:'', odo:'', state:'Tamil Nadu', litres:25.9, actual:1685, discount:26, final:1659, payment:'Cash', split_cash:null, split_gpay:null, shift:'Mid-shift fill', totalizers:{} },
      { id: 'f2', ts: new Date(Date.now()-86400000*30).toISOString(), entry_type:'sale', employee:'Bhagavathi', machine:'cb', vehicle:'KL17Y8949', driver:'Samvel', driverPh:'9361771027', company:'Bagavan Company', coPh:'', odo:'', state:'Kerala', litres:14.8, actual:814, discount:15, final:799, payment:'Cash', split_cash:null, split_gpay:null, shift:'Mid-shift fill', totalizers:{} },
      { id: 'f3', ts: new Date(Date.now()-86400000*3).toISOString(), entry_type:'sale', employee:'Basil', machine:'cb', vehicle:'TN59DC0823', driver:'Moses', driverPh:'7092917251', company:'MTR Transport', coPh:'', odo:'', state:'Tamil Nadu', litres:40.4, actual:2222, discount:40, final:2182, payment:'GPay + Cash Discount', split_cash:40, split_gpay:2222, shift:'Mid-shift fill', totalizers:{} },
      { id: 'f4', ts: new Date(Date.now()-86400000*2).toISOString(), entry_type:'sale', employee:'Basil', machine:'hp', vehicle:'TN30CV5334', driver:'Kumar', driverPh:'9626349596', company:'TMA', coPh:'', odo:'', state:'Tamil Nadu', litres:9.09, actual:591, discount:9, final:582, payment:'Cash', split_cash:null, split_gpay:null, shift:'Mid-shift fill', totalizers:{} },
      { id: 'f5', ts: new Date(Date.now()-3600000*2).toISOString(), entry_type:'sale', employee:'Basil', machine:'cb', vehicle:'TN72AB1234', driver:'Mariyappan', driverPh:'9786932624', company:'MMS Transport', coPh:'', odo:'', state:'Tamil Nadu', litres:20, actual:1100, discount:20, final:1080, payment:'GPay / UPI', split_cash:null, split_gpay:null, shift:'Mid-shift fill', totalizers:{} },
      { id: 'f6', ts: new Date(Date.now()-86400000*1).toISOString(), entry_type:'test', employee:'Basil', machine:'hp', vehicle:null, driver:null, driverPh:null, company:null, coPh:null, odo:null, state:null, litres:5, actual:0, discount:0, final:0, payment:null, split_cash:null, split_gpay:null, shift:'Mid-shift fill', totalizers:{} },
      { id: 'f7', ts: new Date(Date.now()-86400000*1 + 3600000).toISOString(), entry_type:'spillage', employee:'Bhagavathi', machine:'cb', vehicle:'KL17Y8949', driver:'Samvel', driverPh:'9361771027', company:'Bagavan Company', coPh:'', odo:'', state:'Kerala', litres:2.5, actual:0, discount:0, final:0, payment:null, split_cash:null, split_gpay:null, shift:'Mid-shift fill', totalizers:{} },
    ];
