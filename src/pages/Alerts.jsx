...
import { MessageSquare, AlertTriangle, AlertCircle, CheckCircle, ArrowUpDown } from 'lucide-react';
import CustomerDetailModal from '../components/CustomerDetailModal';
import { ACTIVE_DAYS, AT_RISK_DAYS, BUSINESS_NAME, BUSINESS_LOCATION } from '../config/constants';

export default function Alerts({ customers, fills, triggerToast, refreshData, userRole }) {
